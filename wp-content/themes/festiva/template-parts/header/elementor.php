...
<?php 
$logo_m = festiva()->get_theme_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$logo_m_c = festiva()->get_page_opt( 'logo_m_c');
$p_menu = festiva()->get_page_opt('p_menu');
$sticky_scroll = festiva()->get_opt('sticky_scroll');
$pm_menu = festiva()->get_theme_opt('pm_menu');
...
$mobile_style = festiva()->get_theme_opt('mobile_style');
$mobile_display = festiva()->get_opt('mobile_display');
$header_display = festiva()->get_page_opt('header_display', 'show');
?>
                        ...
                        <div class="row">
                            ...
                            <div class="pxl-header-menu">
                                <div class="pxl-header-menu-scroll">
                                    ...
                                    <?php festiva_header_mobile_search_form(); ?>
