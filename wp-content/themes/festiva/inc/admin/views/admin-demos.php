<main>
	...
	<div class="pxl-dashboard-wrap">
		...
		elseif( !empty($plugin_requires) && sizeof($plugin_requires) >= 1 ):
			...
			echo '<div class="error"><p>';
			echo sprintf( wp_kses_post( esc_html__( 'Make sure to activate required plugins prior to import a demo.', 'festiva' ) ), festiva()->get_name(), '<a class="nt-atpli" href="' . admin_url( 'admin.php?page=pxlart-plugins') . '">' , '</a>' ) . '</p>';
