...
if (!class_exists('Festiva_Main')) { 
    class Festiva_Main extends Festiva_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Festiva_Main();
            }
...
function festiva() {
    return Festiva_Main::getInstance();
}
// Install
festiva(); 
