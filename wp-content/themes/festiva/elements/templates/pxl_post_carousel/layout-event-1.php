...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-event-carousel pxl-event-carousel1 pxl-event-style1 <?php echo esc_attr($settings['event_style_l1']); ?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'festiva'); ?>"<?php endif; ?>>
            ...
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    ...
                    foreach ($posts as $post):
                        ...
                        $images_size = !empty($img_size) ? $img_size : '361x241';
