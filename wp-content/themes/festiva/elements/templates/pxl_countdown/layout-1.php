<?php
	...
	extract($settings); 
	$month = esc_html__('Months', 'festiva');
	$months = esc_html__('Months', 'festiva');
	$day = esc_html__('Days', 'festiva');
	$days = esc_html__('Days', 'festiva');
	$hour = esc_html__('Hours', 'festiva');
	$hours = esc_html__('Hours', 'festiva');
	$minute = esc_html__('Minutes', 'festiva');
	$minutes = esc_html__('Minutes', 'festiva');
	$second = esc_html__('Seconds', 'festiva');
	$seconds = esc_html__('Seconds', 'festiva');
	if($style == 'style3') {
		$hour = esc_html__('Hour', 'festiva');
		$hours = esc_html__('Hour', 'festiva');
		$minute = esc_html__('Minutes', 'festiva');
		$minutes = esc_html__('Minutes', 'festiva');
		$second = esc_html__('Seconds', 'festiva');
		$seconds = esc_html__('Seconds', 'festiva');
