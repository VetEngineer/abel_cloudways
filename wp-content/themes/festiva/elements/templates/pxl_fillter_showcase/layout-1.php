...
<div class="pxl-grid pxl-showcase-grid pxl-showcase-grid1 pxl-showcase-layout1 <?php echo esc_attr($settings['style']); ?>">
    <div class="pxl-el-divider visible"></div>
    <?php if (isset($settings['showcase']) && !empty($settings['showcase']) && count($settings['showcase'])): ?>
    <div id="pxl-gallery-<?php echo esc_attr($pxl_g_id); ?>" class="pxl-grid-inner pxl-grid-masonry row" data-gutter="15" data-layout="<?php echo esc_attr($settings['layout_mode']); ?>">
