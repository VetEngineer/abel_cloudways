...
if(class_exists('WPCF7') && !empty($settings['form_id'])) : 
	...
	?>
    <div class="pxl-contact-form pxl-contact-form1-<?php echo pxl_print_html($settings['form_id']); ?><?php echo pxl_print_html($settings['btn_width'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo pxl_print_html($settings['pxl_animate_delay']); ?>ms">
