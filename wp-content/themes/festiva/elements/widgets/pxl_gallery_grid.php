...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Gallery Grid', 'festiva'),
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'img_size',
                            'label' => esc_html__('Image Size Default', 'festiva' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'description' => 'Enter image size (Example: "thumbnail", "medium", "large", "full" or other sizes defined by theme). Alternatively enter size in pixels (Example: 200x100 (Width x Height).',
                        ),
                        array(
                            'name' => 'img_size_popup',
                            'label' => esc_html__('Image Size Popup', 'festiva' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'description' => 'Enter image size (Example: "thumbnail", "medium", "large", "full" or other sizes defined by theme). Alternatively enter size in pixels (Example: 200x100 (Width x Height).',
                        ),
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-grid.pxl-gallery-grid1 img ' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ),
                    ),
                ),
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'spacing',
                            'label' => esc_html__('Spacing', 'festiva' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'nogap',
                            'options' => [
                                'nogap' => 'No Gap',
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-grid.pxl-gallery-grid1.pxl-grid-custom' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'condition' => [
                                'spacing'   => 'custom',
                            ],
