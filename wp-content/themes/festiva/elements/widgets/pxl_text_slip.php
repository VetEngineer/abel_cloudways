...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_text_slip',
        'title' => esc_html__('BR Text Slip', 'festiva' ),
        'icon' => 'eicon-heading',
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'banner',
                            'label' => esc_html__('Banner', 'festiva' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'no' => 'No',
                                'yes' => 'Yes',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Style Text Color','festiva'),
                            'type'  => \Elementor\Controls_Manager::SELECT,
                            'options'   => [
                                'color_normal'  => 'Normal',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Text Color From','festiva'),
                            'type'  => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Text Color To','festiva'),
                            'type'  => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Text Stroke Width','festiva'),
                            'type'  => \Elementor\Controls_Manager::SLIDER,
                            'control_type'  => 'responsive',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Text Fill Color','festiva'),
                            'type'  => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'effect_speed',
                            'label' => esc_html__('Effect Speed', 'festiva'),
