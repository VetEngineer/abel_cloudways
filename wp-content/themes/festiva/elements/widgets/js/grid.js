    ...
    $(document).on('click', '.pxl-load-more', function(){
        ...
        if(loadmore.filter == 'true'){
            $.ajax({
                ...
                data: {
                    action: 'festiva_get_filter_html',
                    settings: loadmore,
                    loadmore_filter: 1
                }
            }).done(function (res) { 
        ...
        $.ajax({
            ...
            data: {
                action: 'festiva_load_more_post_grid',
                settings: loadmore
            }
        })
        .done(function (res) {   
...
$(document).on('click', '.pxl-grid-pagination .ajax a.page-numbers', function(){
    ...
    $.ajax({
        ...
        data: {
            action: 'festiva_get_pagination_html',
...
$( window ).on( 'elementor/frontend/init', function() {
    ...
    elementorFrontend.hooks.addAction( 'frontend/element_ready/pxl_filter_showcase.default', widget_post_masonry_handler );
} );
} )( jQuery );