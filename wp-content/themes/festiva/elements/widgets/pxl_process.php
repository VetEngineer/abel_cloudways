...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_process',
        'title' => esc_html__('BR Process', 'festiva' ),
                    ...
                    'controls' => array(
                        array(
                         ...
                         array(
                            ...
                            'description' => esc_html__('Use For Layout 2', 'festiva' ),
                        ),
                        array(
                            'name' => 'step',
                        ...
                        array(
                            'name'  => 'max_width_desc',
                            'label' => esc_html__('Max Width Description','festiva'),
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-process .pxl-item--description' => 'max-width: {{SIZE}}{{UNIT}} !important;',
                            ],
                        ),
                    ),
                ),
