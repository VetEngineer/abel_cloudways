...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Text Editor', 'festiva'),
        'icon' => 'eicon-text',
        ...
        'params' => array(
            'sections' => array(
                array(
                    ...
                    'label' => esc_html__('Text Editor', 'festiva' ),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'festiva' ),
                            'description' => 'Create Highlight text width shortcode: [pxl_highlight text="Text festiva"]',
                        ),
                        array(
                          'name' => 'align',
                ...
                array(
                    ...
                    'label' => esc_html__('Highlight', 'festiva' ),
