...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Showcase Grid', 'festiva'),
        'icon' => 'eicon-parallax',
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'btn_text',
                                    'label' => esc_html__('Button Text 1', 'festiva'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                ),
                                array(
                                    'name' => 'btn_link',
                                    'label' => esc_html__('Button Link 1', 'festiva'),
                                    'type' => \Elementor\Controls_Manager::URL,
                                    'label_block' => true,
                                ),
                                array(
                                    'name' => 'btn_text2',
                                    'label' => esc_html__('Button Text 2', 'festiva'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'description'   => 'Apply layout 2',
                                ),
                                array(
                                    'name' => 'btn_link2',
                                    'label' => esc_html__('Button Link 2', 'festiva'),
                                    'type' => \Elementor\Controls_Manager::URL,
                                    'label_block' => true,
                                    'description'   => 'Apply layout 2',
                                ),
