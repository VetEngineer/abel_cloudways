...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Process Carousel', 'festiva'),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elements/widgets/img-layout/pxl_process/layout1.png'
                                ],
                            ],
                        ),
                    ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-process .pxl-item--title' => 'color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-process .pxl-item--description' => 'color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                        ...
                        array(
                            'name' => 'step_color',
                            'label' => esc_html__('Step Color', 'festiva' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-process .pxl-item--step' => 'color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'step_typography',
                            'label' => esc_html__('Step Typography', 'festiva' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
