			...
			'options', array(
				...
				'posts_navigation_scroll_which_block'  => array(
					...
					'desc'    => wp_kses_data( __( "Load only the content of the next article or the article and sidebar together.", 'prisma' ) )
								. '<br>'
								. wp_kses_data( __( "Attention! If you override sidebar position or content width on single posts (e.g. the sidebar is displayed on some posts and hidden on others), please don’t use the 'Full post' option to prevent improper content positioning.", 'prisma' ) ),
					'dependency' => array(
						'posts_navigation' => array( 'scroll' ),
					),
					'std'     => 'article',
