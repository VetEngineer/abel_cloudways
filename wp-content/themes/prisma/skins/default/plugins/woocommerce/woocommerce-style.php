...
if ( ! function_exists( 'prisma_woocommerce_get_css' ) ) {
	add_filter( 'prisma_filter_get_css', 'prisma_woocommerce_get_css', 10, 2 );
	function prisma_woocommerce_get_css( $css, $args ) {
...
$fdir = prisma_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
