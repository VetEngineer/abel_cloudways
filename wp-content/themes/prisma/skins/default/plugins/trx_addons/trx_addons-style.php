...
if ( ! function_exists( 'prisma_trx_addons_get_css' ) ) {
	add_filter( 'prisma_filter_get_css', 'prisma_trx_addons_get_css', 10, 2 );
	function prisma_trx_addons_get_css( $css, $args ) {
