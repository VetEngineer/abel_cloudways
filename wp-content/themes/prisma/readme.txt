...
Please install and activate it before starting to use the theme Quirky.
...
Theme documentation is available on https://prisma.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Quirky is Fontello.
